"""
Clean File Upload System
Handles PDF and XLSX file uploads with batch processing support
No OCR dependencies - focuses on direct file processing
"""
...
class CleanUploadHandler:
    """
    Clean file upload handler focused on PDF and XLSX files
    Supports bulk uploads with preview generation
    """
    
    def __init__(self, upload_folder='uploads', temp_folder='temp_uploads'):
        self.upload_folder = upload_folder
        self.temp_folder = temp_folder
        self.allowed_extensions = {'.pdf', '.xlsx', '.xls'}
    ...
    def validate_file(self, file):
        ...
        if file_ext not in self.allowed_extensions:
            return False, f"File type {file_ext} not supported. Only PDF and XLSX files allowed.", None
        ...
        file_info = {
            ...
            'type': 'pdf' if file_ext == '.pdf' else 'excel'
        }
