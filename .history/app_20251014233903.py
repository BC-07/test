...
import pickle
from utils import ResumeProcessor, PersonalDataSheetProcessor
...
class ResumeScreeningApp:
    def __init__(self):
        ...
        # Initialize processors (temporarily skip PDS processor to avoid network issues)
        try:
            self.resume_processor = ResumeProcessor()
            logger.info("Resume processor initialized successfully")
        except Exception as e:
            logger.warning(f"Resume processor initialization failed: {e}")
        ...
        try:
            ...
            logger.warning(f"PDS processor initialization failed (network issue): {e}")
        ...
        try:
            ...
            logger.warning(f"Assessment engine initialization failed: {e}")
    ...
    def _register_routes(self):
        ...
        self.app.add_url_rule('/api/upload-ocr', 'upload_ocr', self.upload_ocr, methods=['POST'])
    ...
    def _extract_and_store_pds(self, filepath, filename, job_data, batch_id):
        ...
        try:
            # Import our working extraction components
