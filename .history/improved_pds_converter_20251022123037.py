#!/usr/bin/env python3
"""
Improved PDS Data Converter
Converts ImprovedPDSExtractor output to assessment format
"""

def convert_improved_pds_to_assessment_format(extracted_data):
    """
    Convert extracted PDS data from ImprovedPDSExtractor to assessment format
    """
    converted_data = {
        'basic_info': {},
        'education': [],
    ...
    # Extract personal information from ImprovedPDSExtractor format
