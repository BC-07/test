...
class HelpSystem {
    ...
    attachToDashboardButton() {
        // Find existing help button in dashboard
        const existingHelp = document.querySelector('.top-bar-right .btn-icon[title*="Help"], .top-bar-right .btn-icon i.fa-question')?.closest('.btn-icon');
     ...
     */
    bindEvents() {
        // Use existing dashboard help button
        const existingHelp = document.querySelector('.top-bar-right .btn-icon[title*="Help"], .top-bar-right .btn-icon i.fa-question')?.closest('.btn-icon');
