...
class NotificationSystem {
     ...
     */
    bindEvents() {
        // Use existing dashboard notification button - be more specific
        const existingBell = document.querySelector('.top-bar-right .btn-icon[title="Notifications"]');
        const panel = document.getElementById('notificationPanel');
        
        console.log('🔔 Notification system binding events...');
        console.log('Notification button found:', existingBell);
        console.log('Notification panel found:', panel);
        
        if (existingBell && panel) {
            ...
            console.log('📢 Event listener attached to notification button');
        } else {
            console.warn('Could not find notification button or panel to attach events');
        }
