...
class PersonalDataSheetProcessor:
    ...
    def process_excel_pds_file(self, file_path, filename, job=None):
        """Process Excel PDS file and return formatted candidate data"""
        try:
            ...
            if extracted_data:
                ...
                converted_data = convert_pds_to_assessment_format(extracted_data, file_path)
                ...
                return {
                    ...
                    'resume_text': f"PDS processed from {filename}",
                    'category': 'PDS',
                    'skills': [],
